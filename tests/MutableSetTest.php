...
class MutableSetTest extends TestCase
{
    ...
    {
        $col = new Collection([
            'bar' => new TestClass3(), 'bob' => new TestClass5(),
        ]);
        ...
        $expected = new MutableCollection([
            'bar' => '{"foo":"bar"}',
            'bob' => '{"foo":"bar-bar"}',
        ]);
    ...
    {
        $col1 = Collection::collect(["a" => "green", "red", "blue", "purple"]);
        ...
        $this->assertContains('purple', $diff);
    }
    ...
    {
        $col = Collection::collect(['foo', 'bar', null, 'baz']);
    ...
    public function testReverse()
    {
        ...
        $this->assertEquals(['foobar' => 'baz2', 'baz' => 'foo', 'bar' => 'baz'], $col->reverse()->toArray());
    }
    ...
    public function testValues()
    {
        ...
        $this->assertEquals(['baz', 'foo', 'baz2'], $col->values()->toArray());
    }
}
